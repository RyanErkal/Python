...
class Solution(object):
    def longestPalindrome(self, s):
        ...
        for i in range(len(s)):
            ...
            largerPalindrome = palindromeOdd if len(
                palindromeOdd) > len(palindromeEven) else palindromeEven
            largestPalindrome = largestPalindrome if len(
                largestPalindrome) >= len(largerPalindrome) else largerPalindrome
            print("")
            print(palindromeOdd)
